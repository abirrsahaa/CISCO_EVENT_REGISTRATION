...
const Info = () => {
  return (
    <div className="w-[100vw]   m-0">
      <div className="flex flex-col md:flex md:flex-row  justify-center h-[500px]  items-center md:w-[100%] md:h-[444px] bg-[#09131D] ">
        {" "}
        <div className="md:w-[60%] md:h-full w-[100%] h-[40%]  rounded-lg flex gap-2 items-center justify-center  ">
          <div className="w-[430px] h-[182px]  flex flex-col items-center justify-center gap-2">
            <div className="text-left md:w-[430px] md:h-[58px] h-[70px] flex items-center md:justify-start justify-center  text-[#13FBD3] md:text-[48px] text-[35px] font-bold ">
              Workshop Pattern
            </div>
            <p className="font-bender md:text-left text-center md:w-[full] leading-7 md:h-[112px] flex items-center justify-center  text-white md:text-[20px] font-normal ">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </p>
          </div>
        </div>
        <div className="font-product-sans relative md:w-[40%] h-[60%] w-[100%] md:h-full  rounded-lg flex flex-row md:gap-2 justify-between md:justify-start">

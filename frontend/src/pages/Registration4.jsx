...
import starterde from "../assets/starterDesk.png";
import starterMo from "../assets/starterMobile.png";
...
const Registration4 = () => {
  ...
  return (
    <div className="w-[100vw] h-[1000px] md:h-[800px] md:[100vh] flex flex-col md:flex md:flex-row items-center justify-center overflow-hidden rounded-3xl">
      <div className="md:h-[90%] h-[1000px] flex overflow-hidden flex-col md:flex md:flex-row justify-center items-center w-[80%] md:w-[70%]  rounded-3xl overflow-hiddden  shadow-3xl  shadow-2xl">
        <div className="h-[250px] overflow-hidden w-[310px] md:w-[420px] md:h-[720px] ">
          <img
            src={starterde}
            alt="img"
            className="h-[100%] w-[100%] object-cover object-center hidden md:block "
          />
          <img
            src={starterMo}
            alt="img"
        ...
        <div className="h-[75%] w-full md:w-[60%] md:h-full relative  bg-white flex flex-col items-center gap-5">
          ...
          <div className="md:w-[416.89px] md:h-[315.23px]  ">
            ...
            <div className="w-[90%] font-benderregular flex px-3 justify-between items-center h-[10%] md:h-[15%] absolute bottom-[350px] md:bottom-[200px]">
              ...
              <button
                  ...
                  try {
                    ...
                    if (!parsedInput.success) {
                      ...
                      for (let i in parsedInput.error.errors) {
                        ...
                        if (
                          parsedInput.error.errors[i].path[0] === "fullname"
                        ) {
                ...
                className="bg-black font-benderregular rounded-3xl w-[40%] h-[50%] md:mr-10 text-white flex items-center justify-center font-bold text-[18px]"
              >
                Register
              </button>
            </div>
